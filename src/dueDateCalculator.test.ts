import {
  adjustDateToBusinessHours,
  calculateDueDate,
} from './dueDateCalculator';

describe('adjustDateToBusinessHours', () => {
  it('adjusts a submit date before 9AM to 9AM of the same day', () => {
    const submitDate = new Date('2025-03-04T06:51:27');
    expect(adjustDateToBusinessHours(submitDate)).toEqual(
      new Date('2025-03-04T09:00:00')
    );
  });

  it('adjusts a submit date at 5PM to 9AM on the next business day', () => {
  ...
  it('adjusts a submit date on Friday after 5PM to the next Monday at 9AM', () => {
  ...
  it('adjusts a submit date on Saturday to the next Monday at 9AM', () => {
  ...
  it('adjusts a submit date on Sunday to the next Monday at 9AM', () => {
